...
contract SettlementTest is DisputeFixture {
    ...
    function testSettlement() public {
        ...
        (
            ...
            TradeStatus statusInStorageAfter,
            bool unwrapOutputInStorageAfter,
            bool isEthTradeInStorageAfter,
        ...
        assertEq(
            uint256(statusInStorageAfter), uint256(TradeStatus.UNINITIALIZED), "Status should be equal to UNINITIALIZED"
        );
    ...
    function testCannotSettleIfDisputed() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(Book__TradeNotFilled.selector, id));
        book.settleTrade(
            testTokenIn, testTokenOut, testAmountIn, testAmountOutMin, testRecipient, tradeIndex, testTrader
        );
    }
