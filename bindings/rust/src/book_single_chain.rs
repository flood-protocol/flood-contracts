...
pub mod book_single_chain {
    ...
    #[doc = "Custom Error type `BookSingleChain__AmountOutTooLow` with signature `BookSingleChain__AmountOutTooLow()` and selector `[165, 55, 84, 167]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__AmountOutTooLow()"
    )]
    pub struct BookSingleChain__AmountOutTooLow;
    #[doc = "Custom Error type `BookSingleChain__DisputePeriodNotOver` with signature `BookSingleChain__DisputePeriodNotOver(uint256)` and selector `[74, 242, 252, 6]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__DisputePeriodNotOver(uint256)"
    )]
    pub struct BookSingleChain__DisputePeriodNotOver {
        pub blocks_left: ethers::core::types::U256,
    }
    #[doc = "Custom Error type `BookSingleChain__DisputePeriodOver` with signature `BookSingleChain__DisputePeriodOver()` and selector `[88, 4, 232, 138]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__DisputePeriodOver()"
    )]
    pub struct BookSingleChain__DisputePeriodOver;
    #[doc = "Custom Error type `BookSingleChain__FeePctTooHigh` with signature `BookSingleChain__FeePctTooHigh(uint256)` and selector `[91, 242, 121, 208]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__FeePctTooHigh(uint256)"
    )]
    pub struct BookSingleChain__FeePctTooHigh {
        pub fee: ethers::core::types::U256,
    }
    #[doc = "Custom Error type `BookSingleChain__InvalidFeeCombination` with signature `BookSingleChain__InvalidFeeCombination()` and selector `[188, 241, 229, 179]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__InvalidFeeCombination()"
    )]
    pub struct BookSingleChain__InvalidFeeCombination;
    #[doc = "Custom Error type `BookSingleChain__InvalidSignature` with signature `BookSingleChain__InvalidSignature()` and selector `[146, 131, 111, 92]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__InvalidSignature()"
    )]
    pub struct BookSingleChain__InvalidSignature;
    #[doc = "Custom Error type `BookSingleChain__InvalidToken` with signature `BookSingleChain__InvalidToken(address)` and selector `[246, 2, 98, 125]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__InvalidToken(address)"
    )]
    pub struct BookSingleChain__InvalidToken {
        pub token: ethers::core::types::Address,
    }
    #[doc = "Custom Error type `BookSingleChain__MaliciousCaller` with signature `BookSingleChain__MaliciousCaller(address)` and selector `[23, 154, 46, 177]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__MaliciousCaller(address)"
    )]
    pub struct BookSingleChain__MaliciousCaller {
        pub caller: ethers::core::types::Address,
    }
    #[doc = "Custom Error type `BookSingleChain__SameToken` with signature `BookSingleChain__SameToken()` and selector `[233, 60, 151, 216]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__SameToken()"
    )]
    pub struct BookSingleChain__SameToken;
    #[doc = "Custom Error type `BookSingleChain__SentToBlackHole` with signature `BookSingleChain__SentToBlackHole()` and selector `[31, 238, 247, 125]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__SentToBlackHole()"
    )]
    pub struct BookSingleChain__SentToBlackHole;
    #[doc = "Custom Error type `BookSingleChain__TradeNotFilled` with signature `BookSingleChain__TradeNotFilled(bytes32)` and selector `[204, 79, 6, 161]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__TradeNotFilled(bytes32)"
    )]
    pub struct BookSingleChain__TradeNotFilled {
        pub trade_id: [u8; 32],
    }
    #[doc = "Custom Error type `BookSingleChain__TradeNotInFillableState` with signature `BookSingleChain__TradeNotInFillableState(bytes32)` and selector `[192, 233, 69, 70]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__TradeNotInFillableState(bytes32)"
    )]
    pub struct BookSingleChain__TradeNotInFillableState {
        pub trade_id: [u8; 32],
    }
    #[doc = "Custom Error type `BookSingleChain__UnsafeTokenToWhitelist` with signature `BookSingleChain__UnsafeTokenToWhitelist(address)` and selector `[79, 16, 187, 188]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__UnsafeTokenToWhitelist(address)"
    )]
    pub struct BookSingleChain__UnsafeTokenToWhitelist {
        pub token: ethers::core::types::Address,
    }
    #[doc = "Custom Error type `BookSingleChain__ZeroAmount` with signature `BookSingleChain__ZeroAmount()` and selector `[171, 197, 238, 111]`"]
    #[derive(
        Clone,
        Debug,
        Default,
    ...
    #[etherror(
        ...
        abi = "BookSingleChain__ZeroAmount()"
    )]
    pub struct BookSingleChain__ZeroAmount;
    #[derive(Debug, Clone, PartialEq, Eq, ethers :: contract :: EthAbiType)]
    pub enum BookSingleChainErrors {
        BookSingleChain__AmountOutTooLow(BookSingleChain__AmountOutTooLow),
        BookSingleChain__DisputePeriodNotOver(BookSingleChain__DisputePeriodNotOver),
        BookSingleChain__DisputePeriodOver(BookSingleChain__DisputePeriodOver),
        BookSingleChain__FeePctTooHigh(BookSingleChain__FeePctTooHigh),
        BookSingleChain__InvalidFeeCombination(BookSingleChain__InvalidFeeCombination),
        BookSingleChain__InvalidSignature(BookSingleChain__InvalidSignature),
        BookSingleChain__InvalidToken(BookSingleChain__InvalidToken),
        BookSingleChain__MaliciousCaller(BookSingleChain__MaliciousCaller),
        BookSingleChain__SameToken(BookSingleChain__SameToken),
        BookSingleChain__SentToBlackHole(BookSingleChain__SentToBlackHole),
        BookSingleChain__TradeNotFilled(BookSingleChain__TradeNotFilled),
        BookSingleChain__TradeNotInFillableState(BookSingleChain__TradeNotInFillableState),
        BookSingleChain__UnsafeTokenToWhitelist(BookSingleChain__UnsafeTokenToWhitelist),
        BookSingleChain__ZeroAmount(BookSingleChain__ZeroAmount),
    }
    impl ethers::core::abi::AbiDecode for BookSingleChainErrors {
        fn decode(
            data: impl AsRef<[u8]>,
        ) -> ::std::result::Result<Self, ethers::core::abi::AbiError> {
            if let Ok(decoded) =
                <BookSingleChain__AmountOutTooLow as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__AmountOutTooLow(
                    decoded,
                ));
            }
            if let Ok(decoded) =
                <BookSingleChain__DisputePeriodNotOver as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__DisputePeriodNotOver(decoded));
            }
            if let Ok(decoded) =
                <BookSingleChain__DisputePeriodOver as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__DisputePeriodOver(
                    decoded,
                ));
            }
            if let Ok(decoded) =
                <BookSingleChain__FeePctTooHigh as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__FeePctTooHigh(
                    decoded,
                ));
            }
            if let Ok(decoded) =
                <BookSingleChain__InvalidFeeCombination as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__InvalidFeeCombination(decoded));
            }
            if let Ok(decoded) =
                <BookSingleChain__InvalidSignature as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__InvalidSignature(
                    decoded,
                ));
            }
            if let Ok(decoded) =
                <BookSingleChain__InvalidToken as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__InvalidToken(
                    decoded,
                ));
            }
            if let Ok(decoded) =
                <BookSingleChain__MaliciousCaller as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__MaliciousCaller(
                    decoded,
                ));
            }
            if let Ok(decoded) =
                <BookSingleChain__SameToken as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(BookSingleChainErrors::BookSingleChain__SameToken(decoded));
            }
            if let Ok(decoded) =
                <BookSingleChain__SentToBlackHole as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__SentToBlackHole(
                    decoded,
                ));
            }
            if let Ok(decoded) =
                <BookSingleChain__TradeNotFilled as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__TradeNotFilled(
                    decoded,
                ));
            }
            if let Ok(decoded) =
                <BookSingleChain__TradeNotInFillableState as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__TradeNotInFillableState(decoded));
            }
            if let Ok(decoded) =
                <BookSingleChain__UnsafeTokenToWhitelist as ethers::core::abi::AbiDecode>::decode(
                    data.as_ref(),
                )
            {
                return Ok(BookSingleChainErrors::BookSingleChain__UnsafeTokenToWhitelist(decoded));
            }
            if let Ok(decoded) =
                <BookSingleChain__ZeroAmount as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(BookSingleChainErrors::BookSingleChain__ZeroAmount(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for BookSingleChainErrors {
        fn encode(self) -> Vec<u8> {
            match self {
                BookSingleChainErrors::BookSingleChain__AmountOutTooLow(element) => {
                    element.encode()
                }
                BookSingleChainErrors::BookSingleChain__DisputePeriodNotOver(element) => {
                    element.encode()
                }
                BookSingleChainErrors::BookSingleChain__DisputePeriodOver(element) => {
                    element.encode()
                }
                BookSingleChainErrors::BookSingleChain__FeePctTooHigh(element) => element.encode(),
                BookSingleChainErrors::BookSingleChain__InvalidFeeCombination(element) => {
                    element.encode()
                }
                BookSingleChainErrors::BookSingleChain__InvalidSignature(element) => {
                    element.encode()
                }
                BookSingleChainErrors::BookSingleChain__InvalidToken(element) => element.encode(),
                BookSingleChainErrors::BookSingleChain__MaliciousCaller(element) => {
                    element.encode()
                }
                BookSingleChainErrors::BookSingleChain__SameToken(element) => element.encode(),
                BookSingleChainErrors::BookSingleChain__SentToBlackHole(element) => {
                    element.encode()
                }
                BookSingleChainErrors::BookSingleChain__TradeNotFilled(element) => element.encode(),
                BookSingleChainErrors::BookSingleChain__TradeNotInFillableState(element) => {
                    element.encode()
                }
                BookSingleChainErrors::BookSingleChain__UnsafeTokenToWhitelist(element) => {
                    element.encode()
                }
                BookSingleChainErrors::BookSingleChain__ZeroAmount(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for BookSingleChainErrors {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                BookSingleChainErrors::BookSingleChain__AmountOutTooLow(element) => element.fmt(f),
                BookSingleChainErrors::BookSingleChain__DisputePeriodNotOver(element) => {
                    element.fmt(f)
                }
                BookSingleChainErrors::BookSingleChain__DisputePeriodOver(element) => {
                ...
                BookSingleChainErrors::BookSingleChain__FeePctTooHigh(element) => element.fmt(f),
                BookSingleChainErrors::BookSingleChain__InvalidFeeCombination(element) => {
                    element.fmt(f)
                }
                BookSingleChainErrors::BookSingleChain__InvalidSignature(element) => element.fmt(f),
                BookSingleChainErrors::BookSingleChain__InvalidToken(element) => element.fmt(f),
                BookSingleChainErrors::BookSingleChain__MaliciousCaller(element) => element.fmt(f),
                BookSingleChainErrors::BookSingleChain__SameToken(element) => element.fmt(f),
                BookSingleChainErrors::BookSingleChain__SentToBlackHole(element) => element.fmt(f),
                BookSingleChainErrors::BookSingleChain__TradeNotFilled(element) => element.fmt(f),
                BookSingleChainErrors::BookSingleChain__TradeNotInFillableState(element) => {
                    element.fmt(f)
                }
                BookSingleChainErrors::BookSingleChain__UnsafeTokenToWhitelist(element) => {
                ...
                BookSingleChainErrors::BookSingleChain__ZeroAmount(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<BookSingleChain__AmountOutTooLow> for BookSingleChainErrors {
        fn from(var: BookSingleChain__AmountOutTooLow) -> Self {
            BookSingleChainErrors::BookSingleChain__AmountOutTooLow(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__DisputePeriodNotOver> for BookSingleChainErrors {
        fn from(var: BookSingleChain__DisputePeriodNotOver) -> Self {
            BookSingleChainErrors::BookSingleChain__DisputePeriodNotOver(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__DisputePeriodOver> for BookSingleChainErrors {
        fn from(var: BookSingleChain__DisputePeriodOver) -> Self {
            BookSingleChainErrors::BookSingleChain__DisputePeriodOver(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__FeePctTooHigh> for BookSingleChainErrors {
        fn from(var: BookSingleChain__FeePctTooHigh) -> Self {
            BookSingleChainErrors::BookSingleChain__FeePctTooHigh(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__InvalidFeeCombination> for BookSingleChainErrors {
        fn from(var: BookSingleChain__InvalidFeeCombination) -> Self {
            BookSingleChainErrors::BookSingleChain__InvalidFeeCombination(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__InvalidSignature> for BookSingleChainErrors {
        fn from(var: BookSingleChain__InvalidSignature) -> Self {
            BookSingleChainErrors::BookSingleChain__InvalidSignature(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__InvalidToken> for BookSingleChainErrors {
        fn from(var: BookSingleChain__InvalidToken) -> Self {
            BookSingleChainErrors::BookSingleChain__InvalidToken(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__MaliciousCaller> for BookSingleChainErrors {
        fn from(var: BookSingleChain__MaliciousCaller) -> Self {
            BookSingleChainErrors::BookSingleChain__MaliciousCaller(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__SameToken> for BookSingleChainErrors {
        fn from(var: BookSingleChain__SameToken) -> Self {
            BookSingleChainErrors::BookSingleChain__SameToken(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__SentToBlackHole> for BookSingleChainErrors {
        fn from(var: BookSingleChain__SentToBlackHole) -> Self {
            BookSingleChainErrors::BookSingleChain__SentToBlackHole(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__TradeNotFilled> for BookSingleChainErrors {
        fn from(var: BookSingleChain__TradeNotFilled) -> Self {
            BookSingleChainErrors::BookSingleChain__TradeNotFilled(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__TradeNotInFillableState> for BookSingleChainErrors {
        fn from(var: BookSingleChain__TradeNotInFillableState) -> Self {
            BookSingleChainErrors::BookSingleChain__TradeNotInFillableState(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__UnsafeTokenToWhitelist> for BookSingleChainErrors {
        fn from(var: BookSingleChain__UnsafeTokenToWhitelist) -> Self {
            BookSingleChainErrors::BookSingleChain__UnsafeTokenToWhitelist(var)
        }
    }
    impl ::std::convert::From<BookSingleChain__ZeroAmount> for BookSingleChainErrors {
        fn from(var: BookSingleChain__ZeroAmount) -> Self {
            BookSingleChainErrors::BookSingleChain__ZeroAmount(var)
        }
    }
    #[derive(
        Clone,
