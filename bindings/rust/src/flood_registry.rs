...
pub mod flood_registry {
    ...
    impl ::core::fmt::Display for FloodRegistryEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                Self::OracleChangedFilter(element) => {
                    ::core::fmt::Display::fmt(element, f)
                }
    ...
    impl ::core::convert::From<OracleChangedFilter> for FloodRegistryEvents {
        fn from(value: OracleChangedFilter) -> Self {
            Self::OracleChangedFilter(value)
        }
    }
    ...
    impl ::ethers::core::abi::AbiDecode for FloodRegistryCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <LatestOracleCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::LatestOracle(decoded));
            }
            if let Ok(decoded)
            ...
            if let Ok(decoded)
                = <SetOracleCall as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::core::fmt::Display for FloodRegistryCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
                ...
                Self::LatestOracle(element) => ::core::fmt::Display::fmt(element, f),
    ...
    impl ::core::convert::From<LatestOracleCall> for FloodRegistryCalls {
        fn from(value: LatestOracleCall) -> Self {
            Self::LatestOracle(value)
        }
    }
    ...
    impl ::core::convert::From<SetOracleCall> for FloodRegistryCalls {
