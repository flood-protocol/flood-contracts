pub use i_all_knowing_oracle_events::*;
...
pub mod i_all_knowing_oracle_events {
    ...
    impl<M> std::fmt::Debug for IAllKnowingOracleEvents<M> {
    ...
    impl ethers::contract::EthLogDecode for IAllKnowingOracleEventsEvents {
            ...
            Self: Sized,
        {
            ...
            if let Ok(decoded) = RequesterWhitelistedFilter::decode_log(log) {
                return Ok(IAllKnowingOracleEventsEvents::RequesterWhitelistedFilter(
                    decoded,
                ));
            }
    ...
    impl ::std::fmt::Display for IAllKnowingOracleEventsEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                ...
                IAllKnowingOracleEventsEvents::RequesterWhitelistedFilter(element) => {
                    element.fmt(f)
                }
