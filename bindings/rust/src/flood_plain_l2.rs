...
pub mod flood_plain_l2 {
    ...
    impl ::ethers::core::abi::AbiDecode for FloodPlainL2Errors {
        fn decode(
            ...
            if let Ok(decoded)
                = <IncorrectValueReceived as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::IncorrectValueReceived(decoded));
            }
            if let Ok(decoded)
                = <InsufficientAmountPulled as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::InsufficientAmountPulled(decoded));
            }
            if let Ok(decoded)
                = <InsufficientAmountReceived as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::InsufficientAmountReceived(decoded));
            }
            if let Ok(decoded)
                = <NotAContract as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::NotAContract(decoded));
            }
            if let Ok(decoded)
                = <TooManyDecoders as ::ethers::core::abi::AbiDecode>::decode(data) {
    ...
    impl ::ethers::core::abi::AbiDecode for FloodPlainL2Calls {
        fn decode(
            ...
            if let Ok(decoded)
                = <AddDecoderCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <EtchOrderCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::EtchOrder(decoded));
            }
            if let Ok(decoded)
                = <FulfillEtchedOrderCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
            ...
            if let Ok(decoded)
                = <GetDecoderCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <GetOrderValidityCall as ::ethers::core::abi::AbiDecode>::decode(
                    data,
                ) {
                return Ok(Self::GetOrderValidity(decoded));
            }
            if let Ok(decoded)
                = <GetPermitHashCall as ::ethers::core::abi::AbiDecode>::decode(data) {
