...
pub mod decoder_with_registry {
    ...
    pub static DECODERWITHREGISTRY_ABI: ::ethers::contract::Lazy<
        ::ethers::core::abi::Abi,
    ...
    pub static DECODERWITHREGISTRY_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __BYTECODE,
    );
    #[rustfmt::skip]
    ...
    pub static DECODERWITHREGISTRY_DEPLOYED_BYTECODE: ::ethers::core::types::Bytes = ::ethers::core::types::Bytes::from_static(
        __DEPLOYED_BYTECODE,
    );
    ...
    impl ::ethers::contract::EthLogDecode for DecoderWithRegistryEvents {
        fn decode_log(
            ...
            if let Ok(decoded) = OwnershipTransferStartedFilter::decode_log(log) {
                return Ok(
                    DecoderWithRegistryEvents::OwnershipTransferStartedFilter(decoded),
                );
            }
            if let Ok(decoded) = OwnershipTransferredFilter::decode_log(log) {
                return Ok(
                    DecoderWithRegistryEvents::OwnershipTransferredFilter(decoded),
                );
            }
    ...
    impl ::ethers::core::abi::AbiDecode for DecoderWithRegistryCalls {
        fn decode(
            ...
            if let Ok(decoded)
                = <FulfillersCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <SetFulfillerCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::SetFulfiller(decoded));
            }
            if let Ok(decoded)
                = <SetTokenCall as ::ethers::core::abi::AbiDecode>::decode(data) {
                return Ok(Self::SetToken(decoded));
            }
            if let Ok(decoded)
                = <SetZoneCall as ::ethers::core::abi::AbiDecode>::decode(data) {
            ...
            if let Ok(decoded)
                = <ZonesCall as ::ethers::core::abi::AbiDecode>::decode(data) {
